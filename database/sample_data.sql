...
(1, 'language_action_successful', 'Language {action}d successfully!'),
(1, 'language_action_failed', 'Failed to {action} language.'),
(1, 'language_management', 'Language Management'),
(1, 'add_new_language', 'Add New Language'),
(1, 'total_languages', 'Total Languages'),
(1, 'active_languages', 'Active Languages'),
(1, 'rtl_languages', 'RTL Languages'),
(1, 'default_language', 'Default Language'),
(1, 'none', 'None'),
(1, 'languages', 'Languages'),
(1, 'no_languages_found', 'No languages found.'),
(1, 'add_first_language', 'Add First Language'),
(1, 'language', 'Language'),
(1, 'code', 'Code'),
(1, 'direction', 'Direction'),
(1, 'translations', 'translations'),
(1, 'inactive', 'Inactive'),
(1, 'manage_translations', 'Manage Translations'),
(1, 'edit', 'Edit'),
(1, 'deactivate', 'Deactivate'),
(1, 'confirm_deactivate_language', 'Are you sure you want to deactivate this language?'),
(1, 'activate', 'Activate'),
(1, 'delete', 'Delete'),
(1, 'confirm_delete_language', 'Are you sure you want to delete this language? This will also delete all translations.'),
(1, 'manage_all_translations', 'Manage All Translations'),
(1, 'import_translations', 'Import Translations'),
(1, 'export_translations', 'Export Translations'),
(1, 'language_statistics', 'Language Statistics'),
(1, 'direction_breakdown', 'Direction Breakdown'),
(1, 'status_breakdown', 'Status Breakdown'),
(1, 'translation_coverage', 'Translation Coverage'),
(1, 'average_translations_per_language', 'Average translations per language'),
(1, 'pricing_plans_management', 'Pricing Plans Management'),
(1, 'add_pricing_plan', 'Add Pricing Plan'),
(1, 'total_plans', 'Total Plans'),
(1, 'active_plans', 'Active Plans'),
(1, 'popular_plans', 'Popular Plans'),
(1, 'average_price', 'Average Price'),
(1, 'search_by_plan_name_code_or_description', 'Search by plan name, code, or description'),
(1, 'pricing_plans', 'Pricing Plans'),
(1, 'no_pricing_plans_found', 'No pricing plans found'),
(1, 'add_first_pricing_plan_to_get_started', 'Add your first pricing plan to get started.'),
(1, 'plan_name', 'Plan Name'),
(1, 'billing_cycle', 'Billing Cycle'),
(1, 'limits', 'Limits'),
(1, 'features', 'Features'),
...
(1, 'projects', 'Projects'),
(1, 'more', 'more'),
(1, 'no_features_listed', 'No features listed'),
(1, 'view', 'View'),
(1, 'confirm_delete_pricing_plan', 'Are you sure you want to delete this pricing plan?'),
(1, 'subscription_plans', 'Subscription Plans'),
(1, 'subscription_plans_management', 'Subscription Plans Management'),
(1, 'subscription_plans_feature', 'Subscription Plans Feature'),
(1, 'subscription_plans_feature_description', 'The subscription plans management feature is not implemented in the current schema. Companies are managed with basic subscription plans (Basic, Professional, Enterprise) stored directly in the companies table.'),
(1, 'basic_plan', 'Basic Plan'),
(1, 'basic_plan_description', 'Standard features for small companies'),
(1, 'professional_plan', 'Professional Plan'),
(1, 'professional_plan_description', 'Advanced features for growing companies'),
(1, 'enterprise_plan', 'Enterprise Plan'),
(1, 'enterprise_plan_description', 'Full features for large companies'),
(1, 'manage_companies', 'Manage Companies'),
(1, 'back_to_dashboard', 'Back to Dashboard'),
(1, 'construction_saas_platform_title', 'Construction SaaS Platform - Advanced Construction Management'),
(1, 'construction_saas_platform', 'Construction SaaS Platform'),
(1, 'advanced_construction_management_solution', 'Advanced Construction Management Solution'),
(1, 'hero_description', 'Streamline your construction projects with our comprehensive SaaS platform. Manage employees, machines, contracts, and finances all in one place.'),
(1, 'get_started', 'Get Started'),
(1, 'learn_more', 'Learn More'),
(1, 'real_time_analytics', 'Real-time Analytics'),
(1, 'real_time_analytics_description', 'Monitor your construction projects with advanced analytics and reporting tools.'),
(1, 'powerful_features', 'Powerful Features'),
(1, 'features_description', 'Everything you need to manage your construction business'),
(1, 'employee_management_description', 'Track employee attendance, salaries, and performance with advanced HR tools.'),
(1, 'machine_management_description', 'Monitor equipment usage, maintenance schedules, and operational costs.'),
(1, 'contract_management_description', 'Manage project contracts, track progress, and handle payments efficiently.'),
(1, 'financial_analytics_description', 'Comprehensive financial reporting and expense tracking for better decision making.'),
(1, 'multi_tenant_saas', 'Multi-tenant SaaS'),
(1, 'multi_tenant_saas_description', 'Secure, scalable platform supporting multiple construction companies.'),
(1, 'mobile_responsive', 'Mobile Responsive'),
(1, 'mobile_responsive_description', 'Access your construction data anywhere, anytime with our mobile-friendly interface.'),
(1, 'choose_your_plan', 'Choose Your Plan'),
(1, 'pricing_description', 'Flexible pricing plans designed for construction companies of all sizes'),
(1, 'most_popular', 'Most Popular'),
(1, 'professional', 'Professional'),
(1, 'up_to_50_employees', 'Up to 50 employees'),
(1, '100_machines', '100 machines'),
(1, 'advanced_reporting', 'Advanced reporting'),
(1, 'priority_support', 'Priority support'),
(1, 'mobile_app_access', 'Mobile app access'),
(1, 'api_access', 'API access'),
(1, 'basic', 'Basic'),
(1, 'up_to_10_employees', 'Up to 10 employees'),
(1, '25_machines', '25 machines'),
(1, 'basic_reporting', 'Basic reporting'),
(1, 'email_support', 'Email support'),
(1, 'enterprise', 'Enterprise'),
(1, 'unlimited_employees', 'Unlimited employees'),
(1, 'unlimited_machines', 'Unlimited machines'),
(1, 'custom_reporting', 'Custom reporting'),
(1, '24_7_support', '24/7 support'),
(1, 'custom_integrations', 'Custom integrations'),
(1, 'what_our_clients_say', 'What Our Clients Say'),
(1, 'real_feedback_from_construction_professionals', 'Real feedback from construction professionals'),
(1, 'testimonial_1', 'This platform has revolutionized how we manage our construction projects. The employee tracking and machine management features are incredible.'),
(1, 'john_smith', 'John Smith'),
(1, 'construction_manager_abc_construction', 'Construction Manager, ABC Construction'),
(1, 'testimonial_2', 'The financial analytics and reporting tools have given us complete visibility into our project costs and profitability.'),
(1, 'sarah_johnson', 'Sarah Johnson'),
(1, 'project_director_xyz_builders', 'Project Director, XYZ Builders'),
(1, 'testimonial_3', 'The multi-tenant architecture allows us to manage multiple construction sites efficiently. Highly recommended!'),
(1, 'mike_davis', 'Mike Davis'),
(1, 'ceo_metro_construction', 'CEO, Metro Construction'),
(1, 'get_in_touch', 'Get In Touch'),
(1, 'ready_to_transform_your_construction_business', 'Ready to transform your construction business? Contact us today!'),
(1, 'contact_information', 'Contact Information'),
(1, 'address', 'Address'),
(1, 'phone', 'Phone'),
(1, 'email', 'Email'),
(1, 'website', 'Website'),
(1, 'follow_us', 'Follow Us'),
(1, 'send_us_a_message', 'Send us a Message'),
(1, 'full_name', 'Full Name'),
(1, 'email_address', 'Email Address'),
(1, 'phone_number', 'Phone Number'),
(1, 'company_name', 'Company Name'),
(1, 'subject', 'Subject'),
(1, 'select_a_subject', 'Select a subject'),
(1, 'general_inquiry', 'General Inquiry'),
(1, 'pricing_information', 'Pricing Information'),
(1, 'request_demo', 'Request Demo'),
(1, 'technical_support', 'Technical Support'),
(1, 'partnership', 'Partnership'),
(1, 'message', 'Message'),
(1, 'send_message', 'Send Message'),
(1, 'thank_you_for_your_message', 'Thank you for your message! We\'ll get back to you soon.'),
(1, 'an_error_occurred_please_try_again', 'An error occurred. Please try again.'),
(1, 'construction_saas_platform_footer', 'Construction SaaS Platform'),
(1, 'advanced_construction_management_solution_footer', 'Advanced construction management solution for modern construction companies.'),
(1, 'features', 'Features'),
(1, 'company', 'Company'),
(1, 'about_us', 'About Us'),
(1, 'careers', 'Careers'),
...
(1, 'blog', 'Blog'),
(1, 'help_center', 'Help Center'),
(1, 'legal', 'Legal'),
(1, 'privacy_policy', 'Privacy Policy'),
(1, 'terms_of_service', 'Terms of Service'),
(1, 'cookie_policy', 'Cookie Policy'),
(1, 'gdpr', 'GDPR'),
(1, 'copyright_2024_construction_saas_platform', '© 2024 Construction SaaS Platform. All rights reserved.'),
(1, 'made_with_love_for_construction_professionals', 'Made with love for construction professionals'),
...
(2, 'language_action_successful', 'ژبه په بریالیتوب سره {action} شوه!'),
(2, 'language_action_failed', 'د ژبې {action} کول ناکام شول.'),
(2, 'language_management', 'د ژبو مدیریت'),
(2, 'add_new_language', 'نوی ژبه زیاتول'),
(2, 'total_languages', 'ټول ژبې'),
(2, 'active_languages', 'فعال ژبې'),
(2, 'rtl_languages', 'RTL ژبې'),
(2, 'default_language', 'تلوالیزه ژبه'),
(2, 'none', 'هیڅ'),
(2, 'languages', 'ژبې'),
(2, 'no_languages_found', 'هیڅ ژبې و نه موندل شول.'),
(2, 'add_first_language', 'لومړی ژبه زیاتول'),
(2, 'language', 'ژبه'),
(2, 'code', 'کوډ'),
(2, 'direction', 'لار'),
(2, 'translations', 'ژباړې'),
(2, 'inactive', 'غیرفعال'),
(2, 'manage_translations', 'ژباړې مدیریت کول'),
(2, 'edit', 'سمول'),
(2, 'deactivate', 'غیرفعال کول'),
(2, 'confirm_deactivate_language', 'آیا تاسو ډاډه یاست چې دا ژبه غیرفعال کړئ؟'),
(2, 'activate', 'فعال کول'),
(2, 'delete', 'ړنګول'),
(2, 'confirm_delete_language', 'آیا تاسو ډاډه یاست چې دا ژبه ړنګ کړئ؟ دا به هم ټول ژباړې ړنګ کړي.'),
(2, 'manage_all_translations', 'ټول ژباړې مدیریت کول'),
(2, 'import_translations', 'ژباړې واردول'),
(2, 'export_translations', 'ژباړې صادرول'),
(2, 'language_statistics', 'د ژبو احصائیه'),
(2, 'direction_breakdown', 'د لار تجزیه'),
(2, 'status_breakdown', 'د حالت تجزیه'),
(2, 'translation_coverage', 'د ژباړې پوښښ'),
(2, 'average_translations_per_language', 'د هرې ژبې لپاره اوسط ژباړې'),
(2, 'pricing_plans_management', 'د نرخونو پلانونو مدیریت'),
(2, 'add_pricing_plan', 'د نرخ پلان زیاتول'),
(2, 'total_plans', 'ټول پلانونه'),
(2, 'active_plans', 'فعال پلانونه'),
(2, 'popular_plans', 'مشهور پلانونه'),
(2, 'average_price', 'اوسط نرخ'),
(2, 'search_by_plan_name_code_or_description', 'د پلان نوم، کوډ یا تشریح له مخې لټون'),
(2, 'pricing_plans', 'د نرخ پلانونه'),
(2, 'no_pricing_plans_found', 'هیڅ د نرخ پلانونه و نه موندل شول'),
(2, 'add_first_pricing_plan_to_get_started', 'لومړی د نرخ پلان زیاتول ترڅو پیل وکړئ.'),
(2, 'plan_name', 'د پلان نوم'),
(2, 'billing_cycle', 'د تادیې دوره'),
(2, 'limits', 'حدود'),
(2, 'features', 'ځانګړتیاوې'),
(2, 'popular', 'مشهور'),
(2, 'employees', 'کارمندان'),
...
(2, 'projects', 'پروژې'),
(2, 'more', 'نور'),
(2, 'no_features_listed', 'هیڅ ځانګړتیاوې نه دي لیست شوي'),
(2, 'view', 'کتل'),
(2, 'confirm_delete_pricing_plan', 'آیا تاسو ډاډه یاست چې دا د نرخ پلان ړنګ کړئ؟'),
(2, 'subscription_plans', 'د ګډون پلانونه'),
(2, 'subscription_plans_management', 'د ګډون پلانونو مدیریت'),
(2, 'subscription_plans_feature', 'د ګډون پلانونو ځانګړتیا'),
(2, 'subscription_plans_feature_description', 'د ګډون پلانونو مدیریت ځانګړتیا په اوسني سکیم کې نه ده تطبیق شوې. شرکتونه د اساسي ګډون پلانونو (اساسي، مسلکي، سوداګریز) سره مدیریت کیږي چې په مستقیم ډول په شرکتونو جدول کې ساتل کیږي.'),
(2, 'basic_plan', 'اساسي پلان'),
(2, 'basic_plan_description', 'د کوچنیو شرکتونو لپاره معیاري ځانګړتیاوې'),
(2, 'professional_plan', 'مسلکي پلان'),
(2, 'professional_plan_description', 'د ودې موندونکو شرکتونو لپاره پرمختللي ځانګړتیاوې'),
(2, 'enterprise_plan', 'سوداګریز پلان'),
(2, 'enterprise_plan_description', 'د لویو شرکتونو لپاره بشپړ ځانګړتیاوې'),
(2, 'manage_companies', 'شرکتونه مدیریت کول'),
(2, 'back_to_dashboard', 'ډاشبورډ ته بیرته'),
(2, 'construction_saas_platform_title', 'د جوړښت SaaS پلاتفارم - پرمختللي د جوړښت مدیریت'),
(2, 'construction_saas_platform', 'د جوړښت SaaS پلاتفارم'),
(2, 'advanced_construction_management_solution', 'پرمختللي د جوړښت مدیریت حل'),
(2, 'hero_description', 'ستاسو د جوړښت پروژې له زموږ له بشپړ SaaS پلاتفارم سره سمبال کړئ. کارمندان، ماشینونه، تړونونه او مالي چارې په یو ځای کې مدیریت کړئ.'),
(2, 'get_started', 'پیل کول'),
(2, 'learn_more', 'نور زده کول'),
(2, 'real_time_analytics', 'د ریښتیني وخت احصائیه'),
(2, 'real_time_analytics_description', 'ستاسو د جوړښت پروژې له پرمختلو احصائیه او راپور ورکوونکو وسیلو سره وڅارئ.'),
(2, 'powerful_features', 'قوي ځانګړتیاوې'),
(2, 'features_description', 'ټول هغه څه چې تاسو ته د خپل د جوړښت سوداګرۍ مدیریت کولو لپاره اړین دي'),
(2, 'employee_management_description', 'د کارمندانو حاضري، معاشونه او کارکردګي له پرمختلو HR وسیلو سره وڅارئ.'),
(2, 'machine_management_description', 'د تجهیزاتو کارونه، د ساتنې جدولونه او عملیاتي لګښتونه وڅارئ.'),
(2, 'contract_management_description', 'د پروژې تړونونه، پرمختګ او تادیې په اغیزمن ډول مدیریت کړئ.'),
(2, 'financial_analytics_description', 'د غوره پریکړو لپاره بشپړ مالي راپورونه او د لګښت وڅارنه.'),
(2, 'multi_tenant_saas', 'د څو کرایډار SaaS'),
(2, 'multi_tenant_saas_description', 'د څو د جوړښت شرکتونو ملاتړ کونکی خوندي، د پراختیا وړ پلاتفارم.'),
(2, 'mobile_responsive', 'د موبایل وړاندیز'),
(2, 'mobile_responsive_description', 'ستاسو د جوړښت ډاټا هر چیرې، هر وخت له زموږ له موبایل دوستانه څرګندونې سره لاسرسی ومومئ.'),
(2, 'choose_your_plan', 'خپل پلان وټاکئ'),
(2, 'pricing_description', 'د ټولو اندازو د جوړښت شرکتونو لپاره ډیزاین شوي انعطاف وړ نرخ پلانونه'),
(2, 'most_popular', 'ترټولو مشهور'),
(2, 'professional', 'مسلکي'),
(2, 'up_to_50_employees', 'تر 50 کارمندانو پورې'),
(2, '100_machines', '100 ماشینونه'),
(2, 'advanced_reporting', 'پرمختللي راپورونه'),
(2, 'priority_support', 'د لومړیتوب ملاتړ'),
(2, 'mobile_app_access', 'د موبایل اپ لاسرسی'),
(2, 'api_access', 'API لاسرسی'),
(2, 'basic', 'اساسي'),
(2, 'up_to_10_employees', 'تر 10 کارمندانو پورې'),
(2, '25_machines', '25 ماشینونه'),
(2, 'basic_reporting', 'اساسي راپورونه'),
(2, 'email_support', 'د بریښنالیک ملاتړ'),
(2, 'enterprise', 'سوداګریز'),
(2, 'unlimited_employees', 'لامحدود کارمندان'),
(2, 'unlimited_machines', 'لامحدود ماشینونه'),
(2, 'custom_reporting', 'دودیز راپورونه'),
(2, '24_7_support', '24/7 ملاتړ'),
(2, 'custom_integrations', 'دودیز یوځای کول'),
(2, 'what_our_clients_say', 'زموږ د پیرودونکو څه وایي'),
(2, 'real_feedback_from_construction_professionals', 'د د جوړښت مسلکي کسانو له ریښتیني څرګندونو'),
(2, 'testimonial_1', 'دا پلاتفارم زموږ د د جوړښت پروژو د مدیریت کولو ډول انقلابي کړی دی. د کارمندانو وڅارنه او د ماشین مدیریت ځانګړتیاوې ناباوره دي.'),
(2, 'john_smith', 'جان سمیت'),
(2, 'construction_manager_abc_construction', 'د جوړښت مدیر، ABC جوړښت'),
(2, 'testimonial_2', 'د مالي احصائیه او راپور ورکوونکي وسیلې زموږ ته د خپلو پروژو د لګښتونو او ګټورتیا په اړه بشپړ لید ورکړی دی.'),
(2, 'sarah_johnson', 'ساره جانسون'),
(2, 'project_director_xyz_builders', 'د پروژې مدیر، XYZ جوړونکي'),
(2, 'testimonial_3', 'د څو کرایډار جوړښت مو ته اجازه ورکوي چې څو د جوړښت ځایونه په اغیزمن ډول مدیریت کړو. ډیر سپارښتنه کیږي!'),
(2, 'mike_davis', 'مایک ډیویس'),
(2, 'ceo_metro_construction', 'CEO، میترو جوړښت'),
(2, 'get_in_touch', 'په اړیکه کې راشئ'),
(2, 'ready_to_transform_your_construction_business', 'د خپل د جوړښت سوداګرۍ د بدلولو لپاره چمتو یاست؟ نن مو سره په اړیکه کې راشئ!'),
(2, 'contact_information', 'د اړیکې معلومات'),
(2, 'address', 'پته'),
(2, 'phone', 'تلیفون'),
(2, 'email', 'بریښنالیک'),
(2, 'website', 'وېب پاڼه'),
(2, 'follow_us', 'مو تعقیب کړئ'),
(2, 'send_us_a_message', 'مو ته یو پیغام واستوئ'),
(2, 'full_name', 'بشپړ نوم'),
(2, 'email_address', 'د بریښنالیک پته'),
(2, 'phone_number', 'د تلیفون شمیره'),
(2, 'company_name', 'د شرکت نوم'),
(2, 'subject', 'موضوع'),
(2, 'select_a_subject', 'یو موضوع وټاکئ'),
(2, 'general_inquiry', 'عمومي پوښتنه'),
(2, 'pricing_information', 'د نرخ معلومات'),
(2, 'request_demo', 'د ښودنې غوښتنه'),
(2, 'technical_support', 'تخنیکي ملاتړ'),
(2, 'partnership', 'ملاتړ'),
(2, 'message', 'پیغام'),
(2, 'send_message', 'پیغام واستوئ'),
(2, 'thank_you_for_your_message', 'ستاسو د پیغام لپاره مننه! مو به ژر ستاسو سره اړیکه ونیسو.'),
(2, 'an_error_occurred_please_try_again', 'یو تیروتنه رامنځته شوه. مهرباني وکوشئ.'),
(2, 'construction_saas_platform_footer', 'د جوړښت SaaS پلاتفارم'),
(2, 'advanced_construction_management_solution_footer', 'د عصري د جوړښت شرکتونو لپاره پرمختللي د جوړښت مدیریت حل.'),
(2, 'features', 'ځانګړتیاوې'),
(2, 'company', 'شرکت'),
(2, 'about_us', 'زموږ په اړه'),
(2, 'careers', 'مسلکونه'),
(2, 'contact', 'اړیکه'),
(2, 'support', 'ملاتړ'),
(2, 'resources', 'سرچینې'),
(2, 'documentation', 'مستندات'),
(2, 'api_reference', 'API مرجع'),
(2, 'blog', 'بلاګ'),
(2, 'help_center', 'د مرستې مرکز'),
(2, 'legal', 'قانوني'),
(2, 'privacy_policy', 'د محرمیت تګلاره'),
(2, 'terms_of_service', 'د خدمت شرطونه'),
(2, 'cookie_policy', 'د کوکی تګلاره'),
(2, 'gdpr', 'GDPR'),
(2, 'copyright_2024_construction_saas_platform', '© 2024 د جوړښت SaaS پلاتفارم. ټول حقونه ساتل شوي.'),
(2, 'made_with_love_for_construction_professionals', 'د د جوړښت مسلکي کسانو لپاره له مینې سره جوړ شوی'),
