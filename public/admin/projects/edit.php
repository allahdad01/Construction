...
<div class="container-fluid">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-edit"></i> <?php echo __('edit_project'); ?></h1>
    <a href="view.php?id=<?php echo (int)$project_id; ?>" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> <?php echo __('back'); ?></a>
  </div>
  <?php if ($error): ?><div class="alert alert-danger"><?php echo htmlspecialchars($error); ?></div><?php endif; ?>
  <?php if ($success): ?><div class="alert alert-success"><?php echo htmlspecialchars($success); ?></div><?php endif; ?>

  <div class="card shadow">
    <div class="card-header py-3"><h6 class="m-0 font-weight-bold text-primary"><?php echo __('project_information'); ?></h6></div>
    <div class="card-body">
      <form method="POST">
        <div class="row">
          <div class="col-md-6">
            <label class="form-label"><?php echo __('project_name'); ?> *</label>
            <input type="text" class="form-control" name="name" value="<?php echo htmlspecialchars($_POST['name'] ?? $project['name']); ?>" required>
          </div>
          <div class="col-md-6">
            <label class="form-label"><?php echo __('client_name'); ?></label>
        ...
        <div class="row mt-3">
          <div class="col-md-6">
            <label class="form-label"><?php echo __('client_contact'); ?></label>
        ...
        <div class="row mt-3">
          <div class="col-md-4">
            <label class="form-label"><?php echo __('budget'); ?></label>
          ...
          <div class="col-md-4">
            ...
            <select class="form-control" name="status">
              ...
              <option value="active" <?php echo $stsel==='active'?'selected':''; ?>><?php echo __('active'); ?></option>
              <option value="completed" <?php echo $stsel==='completed'?'selected':''; ?>><?php echo __('completed'); ?></option>
              <option value="on_hold" <?php echo $stsel==='on_hold'?'selected':''; ?>><?php echo __('on_hold'); ?></option>
            </select>
          </div>
        </div>
        <div class="mt-3">
