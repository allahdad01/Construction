                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo $base_url; ?>super-admin/companies/view.php?id=<?php echo $company['id']; ?>" 
                                               class="btn btn-sm btn-info" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?php echo $base_url; ?>super-admin/companies/edit.php?id=<?php echo $company['id']; ?>" 
                                               class="btn btn-sm btn-warning" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<?php echo $base_url; ?>super-admin/companies/users.php?company_id=<?php echo $company['id']; ?>" 
                                               class="btn btn-sm btn-success" title="Users">
                                                <i class="fas fa-users"></i>
                                            </a>
                                            <a href="<?php echo $base_url; ?>super-admin/companies/payments.php?company_id=<?php echo $company['id']; ?>" 
                                               class="btn btn-sm btn-primary" title="Payments">
                                                <i class="fas fa-money-bill"></i>
                                            </a>
                                            <?php if ($company['subscription_status'] === 'active'): ?>
                                                <a href="<?php echo $base_url; ?>super-admin/companies/suspend.php?id=<?php echo $company['id']; ?>" 
                                            ...
                                            <?php elseif ($company['subscription_status'] === 'suspended'): ?>
                                                <a href="<?php echo $base_url; ?>super-admin/companies/activate.php?id=<?php echo $company['id']; ?>" 
