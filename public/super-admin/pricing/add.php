...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $conn->prepare("SELECT COUNT(*) as count FROM pricing_plans WHERE plan_code = ?");
        $stmt->execute([$_POST['plan_code']]);
        ...
        $stmt = $conn->prepare("
            INSERT INTO pricing_plans (
                ...
                is_popular, is_active, max_employees, max_machines, max_projects, features
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
                    ...
                    <form method="POST" id="pricingForm">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="plan_code" name="plan_code" 
                                           value="<?php echo htmlspecialchars($_POST['plan_code'] ?? ''); ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" 
                                      placeholder="Brief description of the plan"><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="currency" name="currency">
                                        ...
                                        <option value="AFN" <?php echo ($_POST['currency'] ?? 'USD') === 'AFN' ? 'selected' : ''; ?>><?php echo __('afn'); ?> (<?php echo __('afghan_afghani'); ?>)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="billing_cycle" name="billing_cycle" required>
                                        ...
                                        <option value="monthly" <?php echo ($_POST['billing_cycle'] ?? '') === 'monthly' ? 'selected' : ''; ?>><?php echo __('monthly'); ?></option>
                                        <option value="quarterly" <?php echo ($_POST['billing_cycle'] ?? '') === 'quarterly' ? 'selected' : ''; ?>><?php echo __('quarterly'); ?></option>
                                        <option value="yearly" <?php echo ($_POST['billing_cycle'] ?? '') === 'yearly' ? 'selected' : ''; ?>><?php echo __('yearly'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_employees" name="max_employees" 
                                           value="<?php echo htmlspecialchars($_POST['max_employees'] ?? '0'); ?>" 
                                           min="0">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_machines" name="max_machines" 
                                           value="<?php echo htmlspecialchars($_POST['max_machines'] ?? '0'); ?>" 
                                           min="0">
                                    <small class="text-muted"><?php echo __('0_unlimited'); ?></small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_projects" name="max_projects" 
                                           value="<?php echo htmlspecialchars($_POST['max_projects'] ?? '0'); ?>" 
                                           min="0">
                                    <small class="text-muted"><?php echo __('0_unlimited'); ?></small>
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_popular" name="is_popular" 
                                               <?php echo isset($_POST['is_popular']) ? 'checked' : ''; ?>>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> <?php echo __('add_pricing_plan'); ?>
                            </button>
                        </div>
                    </form>
                </div>
