                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="subscription_plan" name="subscription_plan">
                                        ...
                                        <option value="basic" <?php echo ($_POST['subscription_plan'] ?? '') === 'basic' ? 'selected' : ''; ?>><?php echo __('basic'); ?></option>
                                        <option value="professional" <?php echo ($_POST['subscription_plan'] ?? '') === 'professional' ? 'selected' : ''; ?>><?php echo __('professional'); ?></option>
                                        <option value="enterprise" <?php echo ($_POST['subscription_plan'] ?? '') === 'enterprise' ? 'selected' : ''; ?>><?php echo __('enterprise'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
