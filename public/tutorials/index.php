...
<div class="container-fluid">
            ...
            <div class="card-body">
              ...
              <?php elseif ($t['type']==='pdf'): ?>
                <?php if (!empty($t['file_path'])): ?>
                  <a class="btn btn-outline-primary btn-sm" target="_blank" href="/constract360/construction/<?php echo htmlspecialchars($t['file_path']); ?>"><i class="fas fa-file-pdf me-1"></i> Open PDF</a>
                <?php endif; ?>
  ...
  <?php elseif ($lang): ?>
    <div class="alert alert-info">Select a task to view tutorials.</div>
  <?php else: ?>
    <div class="alert alert-secondary">Select a language to begin.</div>
  <?php endif; ?>
</div>
